...
outputKeys = ['ID','BOM','typeID','description','totalNum','price','totalPrice','productLine','waston', 'addOn'];

outputHeaderLine = ['序号','产品编码','产品型号','项目名称','总数量','单价'	,'总价','产线','WATSON_LINE_ITEM_ID','备注']
